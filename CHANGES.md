...
- **Databases**
  - 5 new terms
  - Spellchecking of all database terms and standardization to US english, performed with new in-house tools

## [0.4.9] - 2025-12-19
### Changed
 - **Detection** 
  - +z pluralization is now caught by matchers, and system is now s/z agnostic
